...
public class ServerRunner {
  ...
  public static void main(String[] args) {
    try {
      ...
      ServerRunner s = new ServerRunner(System.out, 10);
   ...
   **/
  public ServerRunner(OutputStream logStream, int maxConnections) { 
  ...
  public static class Control implements Service {
    ServerRunner server;             // The server we control
     ...
     **/
    public Control(ServerRunner server, String password) {
      this.server = server;
